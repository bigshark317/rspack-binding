...
pub struct RawBetterChunkOptions {
  ...
  pub strict_duplicate_chunk_grouping: Option<bool>,
  pub split_duplicate_groups_by_package: Option<bool>,
...
impl From<RawBetterChunkOptions> for BetterChunkOptions {
  fn from(options: RawBetterChunkOptions) -> Self {
    Self {
      ...
      strict_duplicate_chunk_grouping: options.strict_duplicate_chunk_grouping.unwrap_or(false),
      split_duplicate_groups_by_package: options.split_duplicate_groups_by_package.unwrap_or(false),
